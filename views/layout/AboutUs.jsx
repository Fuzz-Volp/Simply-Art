        ...
        return (
            <main className="bg-gray-200 mb-36 drop-shadow-md w-full">
                <div className="flex justify-center m-12 relative drop-shadow-md ">
                    <img src="https://render.fineartamerica.com/images/images-profile-flow/400/images/artworkimages/mediumlarge/3/wide-open-ocean-art-by-linda-woods-linda-woods.jpg" alt="" className="z-0 object-fill w-5/6 h-96"/>
                ...
                <div className="container mx-auto flex flex-col justify-center items-center">
                    ...
                    <a href="/arts/about">learn more</a>
                </div>
            </main>
        )
    };
